...
* 📕 **[Manual de Configuración y Uso (Español)](docs/es/MANUAL_CONFIGURACION.md):** Guía completa con el catálogo de 24 reglas, esquema de `vetro.yaml`, directivas inline (`// vetro:ignore`), Quality Gates de CI/CD y contrato para agentes de IA.
* 📘 **[Configuration & Usage Manual (English)](docs/CONFIGURATION_MANUAL.md):** Complete guide covering all 24 rules, YAML schema, CLI options, inline suppressions, and AI-Agent Compliance Contracts.
...
* **[Auditoría de PR en Google](docs/google_pr_audit_report.md):** Caso de estudio en el mundo real auditando el PR oficial #1773 de Google (`dart-lang/http`) con cero costo de tokens y análisis determinista en 50 ms.
* **[Auditoría de PR en RxDart](docs/rxdart_pr_audit_report.md):** Validación de integración continua en `ReactiveX/rxdart` PR #784 detectando regresiones y mejoras de arquitectura en 180 ms.
* **[Reporte de Experimentos en GitHub](docs/github_experiments_report.md):** Validación de análisis estático comparativo entre repositorios de producción.
