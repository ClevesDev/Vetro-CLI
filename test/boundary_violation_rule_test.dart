...
void main() {
  group('Boundary Violation Rule', () {
    test(
      'allows clean inward flows (outer layers importing inner layers)',
      () async {
        const sourceDomain = 'class DomainClass {}';
        const sourceApp = "import 'domain/domain.dart'; class AppClass {}";
        const sourceInfra =
            "import '../domain/domain.dart'; class InfraClass {}";
        const sourcePres =
            "import '../../domain/domain.dart'; import '../application/app.dart'; class PresClass {}";
    ...
    test(
      'flags invalid outward flows (inner layers importing outer layers)',
      () async {
        const sourceDomain =
            "import '../presentation/pres.dart'; class DomainClass {}";
        const sourcePres = 'class PresClass {}';
        ...
        final sources = {pathDomain: sourceDomain, pathPres: sourcePres};
        ...
        expect(
          ...
          contains(
            'Boundary violation: Layer "domain" (innermost) cannot import outer layer "presentation"',
          ),
        );
      },
    );
    ...
    test('respects custom layers configuration', () async {
      const sourceCore = "import '../ui/ui.dart'; class CoreClass {}";
      const sourceUi = 'class UiClass {}';
      ...
      final sources = {pathCore: sourceCore, pathUi: sourceUi};
      ...
      expect(
        findings.first.message,
        contains(
          'Boundary violation: Layer "core" (innermost) cannot import outer layer "ui"',
        ),
      );
    });
    ...
    test('ignores unlayered helper files and folders', () async {
      const sourceDomain =
          "import '../shared/utils.dart'; class DomainClass {}";
      const sourceShared =
          "import '../presentation/pres.dart'; class SharedUtils {}";
      const sourcePres = 'class PresClass {}';
    ...
    test('resolves package imports correctly', () async {
      const sourceDomain =
          "import 'package:vetro/presentation/pres.dart'; class DomainClass {}";
      const sourcePres = 'class PresClass {}';
