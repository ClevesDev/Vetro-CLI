...
| Proyecto / Corpus | Archivos | Líneas de Código | Tiempo Promedio | Rendimiento (Líneas/seg) | Clasificación de Carga |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Corpus A (Feature-Based)** | 46 | 7,462 | **333.0 ms** (0.33 s) | **22,408.4** | Ligera |
| **Vetro (Self-Audit)** | 30 | 4,568 | **290.0 ms** (0.29 s) | **15,751.7** | Ligera |
| **Corpus B (Modular App)** | 48 | 6,641 | **417.3 ms** (0.41 s) | **15,912.9** | Ligera |
| **Corpus C (Domain Layered)** | 63 | 8,933 | **477.0 ms** (0.47 s) | **18,727.5** | Ligera |
| **Corpus D (Monorepo ERP)** | 225 | 56,287 | **25,177.0 ms** (25.17 s) | **2,235.7** | Pesada |
...
* Para proyectos como `Corpus A`, `Vetro`, `Corpus B` y `Corpus C`, el analizador se ejecuta en **menos de medio segundo** (300 ms - 480 ms).
...
* Al pasar a `Corpus D` (225 archivos y más de 56,000 líneas), el tiempo promedio se incrementa a **25.17 segundos**, reduciendo el rendimiento a **2,235 líneas/seg**.
...
Para mantener el tiempo de análisis por debajo de 2 segundos en proyectos grandes (> 50,000 líneas) en el futuro, podemos aplicar las optimizaciones descritas en la Hoja de Ruta para 2026:
...
![Gráfica de CPU mostrando el patrón de Thread Migration](../assets/cpu_thread_migration.png)
